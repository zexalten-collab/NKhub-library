...
function NK_Library:CreateWindow(cfg)
    ...
    MobileButton.Size = UDim2.new(0, 110, 0, 36)
    MobileButton.Position = UDim2.new(0.5, -55, 0, 15)
...
-- cień dla lepszej widoczności
    local Shadow = Instance.new("ImageLabel", MobileButton)
...
-- PRZYCISK ZAMYKANIA X (Prawy górny róg GŁÓWNEGO okna)
    ...
    CloseBtn.Position = UDim2.new(1, -32, 0.5, -13) -- idealnie po prawej w Header
